/* <script> */
    ...
    setTimeout(function() {
        ...
        var lpCompareCVGenresCv = $(".lpCompareCV_Genres_cv").height()+40;
        var lpCompareCVGenresInd = $(".lpCompareCV_Genres_ind").height()+40;
        ...
        // For Compare CV with Sub Ind CV Mood Graph Height
        var compareCVSubIndRadarGraphHolder1 = $(".compareCVSubIndRadarGraphHolderCV1_1").height()+20;
        var compareCVSubIndRadarGraphHolder2  = $(".compareCVSubIndRadarGraphHolderCV2_1").height()+20;
        if(compareCVSubIndRadarGraphHolder1 > compareCVSubIndRadarGraphHolder2)
        {
            $(".compareCVSubIndRadarGraphHolderHeight1").css("height",compareCVSubIndRadarGraphHolder1);
        }
        else
        {
            $(".compareCVSubIndRadarGraphHolderHeight1").css("height",compareCVSubIndRadarGraphHolder2);
        }
        // For Compare CV with Sub Ind CV Genre Graph Height
        var compareCVSubIndRadarGraphHolder3 = $(".compareCVSubIndRadarGraphHolderCV1_2").height()+20;
        var compareCVSubIndRadarGraphHolder4  = $(".compareCVSubIndRadarGraphHolderCV2_2").height()+20;
        if(compareCVSubIndRadarGraphHolder3 > compareCVSubIndRadarGraphHolder4)
        {
            $(".compareCVSubIndRadarGraphHolderHeight2").css("height",compareCVSubIndRadarGraphHolder3);
        }
        else
        {
            $(".compareCVSubIndRadarGraphHolderHeight2").css("height",compareCVSubIndRadarGraphHolder4);
        }
...
/* //Start RADAR Graph Script 2
    ...
    if(industryGenreAggrGraphDatasetDataString != '')
    {
        ...
        console.log("cv2lblPostion",cv2lblPostion);
        old_highestGenrellbArr_2.push(cv2dld[cv2lblPostion]);
