/* <script> */
    ...
    if(cv1b7DataCount!=0 && cv1b7DataCount!='' && cv1datasetsData!=',')
    {
        ...
        {
            var cv1pieChartBgColorArrayB7 = pieChartBgColorNames.split(',');
        ...
        var compareCVPieUpdate1 = function () {
            ...
            compareCVPie1 = new d3pie("brandCV1Pie", opt);
        };
        ...
        $.ajax({
            ...
            complete: function(){
                if(cv1sce8DataSetsContent !='' && cv1sce8DataSetsContent !=undefined)
                {
                    ...
                    var brandCV1PieData = [
                            { label: "Yes", value: parseFloat(cv1sce8DataSetsContent[0]) },
                            { label: "No", value: parseFloat(cv1sce8DataSetsContent[1]) }
                        ];

                    var brandCV1Pie;

                    var brandCV1PieUpdate = function () {
                        if (brandCV1Pie) brandCV1Pie.destroy();
                        var div2W = $("#brandCVPieDiv1").width();
                        var div2H = $("#brandCVPieDiv1").height();
                        //var size = Math.min(innerHeight, innerWidth) / 2;
                        var size = Math.min(div2W, div2H);
                        var opt =  {
                            data: {
                                content: brandCV1PieData,
                            },
                            size: {
                                pieInnerRadius: "40%",
                                pieOuterRadius: "72%",
                        ...
                        brandCV1Pie = new d3pie("brandCV1Pie", opt);
                    };
                    brandCV1PieUpdate();
                    window.addEventListener('resize', brandCV1PieUpdate);
                }
                else
                {
    ...
    var fontSIndcv1barChart = 13;
    var layoutPadding = 0;
    if(winWIndcv1barChart < 768) {
        fontSIndcv1barChart = 10;
        yAxesRotationIndcv1barChart = 60;
        layoutPadding = 20;
    }
    else {
        fontSIndcv1barChart = 13;
    ...
    //MUSIC EXPENDITURE (PER YEAR) & MUSIC EXPENDITURE (PER VIDEO)
    //cv
    /* var cv1b14NumberData = "{{$cv1_block_14_data[0]->b14_number}}"; */
    if(cv1b14NumberData != '' && cv1b14NumberData != null)
    {
        /* var cv1mepyUrl = "{{url('get-music-expenditure-per-year-avg')}}"+'/'+"{{$cv1_data->industry_id}}"; */
        var cv1b14Avg = '', cv1b14indAvg = '', cv1b14indPublishedCVSum = '', cv1b14indPublishedCVCount = '', industry_per_year = '';
        $.ajax({
            type: "GET",
            url: cv1mepyUrl,
            data: "",
            success: function(data) {
                ...
                if(data != '' && data != undefined)
                {
                    ...
                    if(data != '' && data != undefined)
                    {
                        ...
                        cv1b14Avg = (cv1b14NumberData - parseFloat(musicExpenditurePerYear/musicExpenditurePerYearCount).toFixed()) / parseFloat(musicExpenditurePerYear/musicExpenditurePerYearCount).toFixed()*100;
                        industry_per_year = (parseFloat(musicExpenditurePerYear/musicExpenditurePerYearCount).toFixed() - cv1b14NumberData) / cv1b14NumberData*100;
            ...
            complete: function(){
                ...
                if(cv1b14Avg != '' && cv1b14Avg != undefined)
                {
                    ...
                    if(Math.sign(industry_per_year) > 0)
                    {
                        $(".lpInd_section_3_count").html('<img src="public/images/lp-growing-arrow.png" alt=""> <span class="count" id="mepyAvg">'+parseFloat(Math.abs(industry_per_year)).toFixed(2)+'% <span class="astrick_count_txt">*</span></span>');
                    }
                    else if(Math.sign(industry_per_year) < 0)
                    {
                        $(".lpInd_section_3_count").html('<img src="public/images/lp-growing-arrowdown.png" alt=""> <span class="count" id="mepyAvg">'+parseFloat(Math.abs(industry_per_year)).toFixed(2)+'% <span class="astrick_count_txt">*</span></span>');
                    }
                    else
                    {
                        $(".lpInd_section_3_count").html('<span class="count" id="mepyAvg">'+parseFloat(Math.abs(industry_per_year)).toFixed(2)+'% <span class="astrick_count_txt">*</span></span>');
                    }
    ...
    /* var cv1b15NumberData = "{{$cv1_block_15_data[0]->b15_number}}"; */
    if(cv1b15NumberData != '' && cv1b15NumberData != null)
    {
        /* var cv1mepvUrl = "{{url('get-music-expenditure-per-video-avg')}}"+'/'+"{{$cv1_data->industry_id}}"; */
        var cv1b15Avg = '', cv1b15indAvg = '', cv1b15indPublishedCVSum = '', cv1b15indPublishedCVCount = '', industry_per_video = '';
        $.ajax({
            type: "GET",
            url: cv1mepvUrl,
            data: "",
            success: function(data) {
                ...
                if(data != '' && data != undefined)
                {
                    ...
                    if(data != '' && data != undefined)
                    {
                        ...
                        cv1b15Avg = (cv1b15NumberData - parseFloat(musicExpenditurePerVideo/musicExpenditurePerVideoCount).toFixed()) / parseFloat(musicExpenditurePerVideo/musicExpenditurePerVideoCount).toFixed()*100;
                        industry_per_video = (parseFloat(musicExpenditurePerVideo/musicExpenditurePerVideoCount).toFixed() - cv1b15NumberData) / cv1b15NumberData*100;
            ...
            complete: function(){
                ...
                if(cv1b15Avg != '' && cv1b15Avg != undefined)
                {
                    ...
                    if(Math.sign(industry_per_video) > 0)
                    {
                        $(".lpInd_section_4_count").html('<img src="public/images/lp-growing-arrow.png" alt=""> <span class="count" id="mepvAvg">'+parseFloat(Math.abs(industry_per_video)).toFixed(2)+'% <span class="astrick_count_txt">*</span></span>');
                    }
                    else if(Math.sign(industry_per_video) < 0)
                    {
                        $(".lpInd_section_4_count").html('<img src="public/images/lp-growing-arrowdown.png" alt=""> <span class="count" id="mepvAvg">'+parseFloat(Math.abs(industry_per_video)).toFixed(2)+'% <span class="astrick_count_txt">*</span></span>');
                    }
                    else
                    {
                        $(".lpInd_section_4_count").html('<span class="count" id="mepvAvg">'+parseFloat(Math.abs(industry_per_video)).toFixed(2)+'% <span class="astrick_count_txt">*</span></span>');
                    }
...
/* //Start Mood RADAR Graph Script 1
    ...
    cv2SocialMediaDataExistArray = industrySocialMediaDataExistArrayString.split(",");
    ...
    if(showMoodRadar == true)
    {
        ...
        // }
        //console.log("cv2SocialMediaDataExistArray == ",cv2SocialMediaDataExistArray," toggellblCompareIndMoodArr1 == ",toggellblCompareIndMoodArr1);
        for(var i=0; i<cv2SocialMediaDataExistArray.length;i++)
        {
            if(toggellblCompareIndMoodArr1.includes(cv2SocialMediaDataExistArray[i])){
                ...
                toggellblCompareIndMoodArr1Index = toggellblCompareIndMoodArr1.indexOf(cv2SocialMediaDataExistArray[i]);
                toggelCompareIndMoodBtns1 += '<div class="toggleWrapper" >';
                toggelCompareIndMoodBtns1 += '<input type="checkbox" id="rtoggleCompareCV2Mood'+toggellblCompareIndMoodArr1[toggellblCompareIndMoodArr1Index]+'" >';
                toggelCompareIndMoodBtns1 += '<label for="rtoggleCompareCV2Mood'+toggellblCompareIndMoodArr1[toggellblCompareIndMoodArr1Index]+'" class="rtoggleCompareCV2Mood'+toggellblCompareIndMoodArr1[toggellblCompareIndMoodArr1Index]+'" onClick="rtoggleCompareCV2MoodData2('+toggellblCompareIndMoodArr1Index+')" ><span class="rtoggleCompareCV2Mood'+toggellblCompareIndMoodArr1[toggellblCompareIndMoodArr1Index]+'_handler"></span></label>';
                toggelCompareIndMoodBtns1 += '<span class="cust-toggleBtnName">'+toggellblCompareIndMoodArr1[toggellblCompareIndMoodArr1Index]+'</span>';
                toggelCompareIndMoodBtns1 += '</div>';
            }else{
...
/* //Start RADAR Graph Script 2
    ...
    if(showMoodRadar == true)
    {
        ...
        else
        {
            ...
            {
                if(toggellblCompareCVGenreArr1.includes(cv1SocialMediaDataExistArray[i])){
                    var toggellblCompareCVGenreArr1Index = toggellblCompareCVGenreArr1.indexOf(cv1SocialMediaDataExistArray[i]);
                    toggelCompareCVGenreBtns1 += '<div class="toggleWrapper">';
                    toggelCompareCVGenreBtns1 += '<input type="checkbox" id="toggle'+toggellblCompareCVGenreArr1[toggellblCompareCVGenreArr1Index]+'" >';
                    toggelCompareCVGenreBtns1 += '<label for="toggle'+toggellblCompareCVGenreArr1[toggellblCompareCVGenreArr1Index]+'" class="toggle'+toggellblCompareCVGenreArr1[toggellblCompareCVGenreArr1Index]+'" onClick="toggleDataCompareCV(\''+toggellblCompareCVGenreArr1[toggellblCompareCVGenreArr1Index]+'\', \'withoutPopup\', \'cv1GenreRadarChart\')" ><span class="toggle'+toggellblCompareCVGenreArr1[toggellblCompareCVGenreArr1Index]+'_handler"></span></label>';
                    toggelCompareCVGenreBtns1 += '<span class="cust-toggleBtnName">'+toggellblCompareCVGenreArr1[toggellblCompareCVGenreArr1Index]+'</span>';
                    toggelCompareCVGenreBtns1 += '</div>';
                }else{
                    toggelCompareCVGenreBtns1 += '<div class="toggleWrapper" style="pointer-events: none;">';
    ...
    if(showMoodRadar == true)
    {
        ...
        else
        {
            ...
            {
                if(toggellblCompareIndGenreArr2.includes(cv2SocialMediaDataExistArray[i])){
                    var toggellblCompareIndGenreArr2Index = toggellblCompareIndGenreArr2.indexOf(cv2SocialMediaDataExistArray[i]);
                    toggelCompareIndGenreBtns2 += '<div class="toggleWrapper">';
                    toggelCompareIndGenreBtns2 += '<input type="checkbox" id="r2toggle'+toggellblCompareIndGenreArr2[toggellblCompareIndGenreArr2Index]+'" >';
                    toggelCompareIndGenreBtns2 += '<label for="r2toggle'+toggellblCompareIndGenreArr2[toggellblCompareIndGenreArr2Index]+'" class="r2toggle'+toggellblCompareIndGenreArr2[toggellblCompareIndGenreArr2Index]+'" onClick="toggleDataCompareCV(\''+toggellblCompareIndGenreArr2[toggellblCompareIndGenreArr2Index]+'\', \'withoutPopup\', \'cv2GenreRadarChart\')" ><span class="r2toggle'+toggellblCompareIndGenreArr2[toggellblCompareIndGenreArr2Index]+'_handler"></span></label>';
                    toggelCompareIndGenreBtns2 += '<span class="cust-toggleBtnName">'+toggellblCompareIndGenreArr2[toggellblCompareIndGenreArr2Index]+'</span>';
                    toggelCompareIndGenreBtns2 += '</div>';
...
/* </script> */
    ...
    function getRadarChartGraphData(call_from){
        ...
        if(call_from == "cv1_Sonic_logo"){
            ...
            var datalablesData = industrySonicLogoMainMoodGraphGraphDatalablesData;
    ...
    if(cv1SonicLogoMainMoodGraphDatasetData.length > 0 && cv1SonicLogoMainMoodGraphDatalablesDataString != ''){
        getRadarChartGraphData("cv1_Sonic_logo")
    }

    if(industrySonicLogoMainMoodGraphDatasetData.length > 0 && industrySonicLogoMainMoodGraphGraphDatalablesDataString != ''){
