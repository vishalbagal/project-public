/* <script> */
    ...
    if(sce8DataSetsContent !='' && sce8DataSetsContent !=undefined)
    {
        ...
        var indCVPieUpdate = function () {
            ...
            var div2W = $("#indCVPieDiv").width();
            var div2H = $("#indCVPieDiv").height();
    ...
    console.log("b13datasetsData"+b13datasetsData);
    if(b13DataCount != '' && b13DataCount != 0)
    {
        ...
        if(winWIndcvBarChart < 768) {
            fontSIndcvBarChart = 10;
            yAxesRotationIndcvBarChart = 25;
            layoutPadding = 20;
        }
        else {
            ...
            scales: {
                ...
                y: {
                    ...
                    ticks: {
                        ...
                        color: '#F1F1F1',
                        maxRotation: yAxesRotationIndcvBarChart,
                        minRotation: yAxesRotationIndcvBarChart
                    }
                }
            },
            plugins: {
...
//start Mood RADAR Graph Script 1
    ...
    if(showMoodRadar == true)
    {
        ...
        // }
        // var socialMediaDataExistArray = socialMediaDataExistArrayString.split(",");
        // console.log("socialMediaDataExistArray = ",socialMediaDataExistArray," toggellblArr==",toggellblArr);
...
//Start RADAR Graph Script 2
    ...
    if(showMoodRadar == true)
    {
        ...
        else
        {
            ...
            for(var i=0; i<socialMediaDataExistArray.length;i++){
                if(toggellbl1Arr.includes(socialMediaDataExistArray[i])){
                    var toggellbl1ArrIndex = toggellbl1Arr.indexOf(socialMediaDataExistArray[i]);
                    toggel1Btns += '<div class="toggleWrapper">';
                    toggel1Btns += '<input type="checkbox" id="r2toggle'+toggellbl1Arr[toggellbl1ArrIndex]+'" >';
                    toggel1Btns += '<label for="r2toggle'+toggellbl1Arr[toggellbl1ArrIndex]+'" class="r2toggle'+toggellbl1Arr[toggellbl1ArrIndex]+'" onClick="toggleDataBrandCV(\''+toggellbl1Arr[toggellbl1ArrIndex]+'\', \'withoutPopup\')" ><span class="r2toggle'+toggellbl1Arr[toggellbl1ArrIndex]+'_handler"></span></label>';
                    toggel1Btns += '<span class="cust-toggleBtnName">'+toggellbl1Arr[toggellbl1ArrIndex]+'</span>';
                    toggel1Btns += '</div>';
                }else{
                    toggel1Btns += '<div class="toggleWrapper" style="pointer-events: none;">';
...
// sonic logo main mood graph data
    ...
    function getRadarChartGraphData(call_from){
        ...
        datalablesData = industrySonicLogoMainMoodGraphDatalabelsData;
        ...
        downIndSlradarGraphDataSetcontent = datasetsContent;
        downIndSlradarGraphDataLabelcontent = datalablesData;
    ...
    if(industrySonicLogoMainMoodGraphDatalabelsData.length > 0 && industrySonicLogoMainMoodGraphDatalabelsData != ''){
