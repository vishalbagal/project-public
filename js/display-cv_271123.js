...
//Start RADAR Graph Script 1
    ...
    if(cvBlock16MoodGraphDatasetDataString != '' && cvBlock17MoodGraphDatasetDataString != '' && cvBlock18MoodGraphDatasetDataString != '' && cvBlock19MoodGraphDatasetDataString != '' && cvMoodAggrGraphDatasetDataString != '')
    {
        ...
        datasetsContent = [{ label: 'Aggregate', data: cvMoodAggrGraphDatasetData, borderColor: 'rgba(118, 119, 122, 1)', backgroundColor: 'rgba(118, 119, 122, 0.7)', pointBackgroundColor: '#76777a', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0},{ label: 'YouTube', data: cvBlock16MoodGraphDatasetData, borderColor: 'rgba(255, 205, 3, 1)', backgroundColor: 'rgba(255, 205, 3, 1)', pointBackgroundColor: '#ffcd03', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0},{ label: 'Instagram', data: cvBlock17MoodGraphDatasetData, borderColor: 'rgba(221, 135, 151, 1)', backgroundColor: 'rgba(221, 135, 151, 1)', pointBackgroundColor: '#dd8797', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0},{ label: 'TikTok', data: cvBlock18MoodGraphDatasetData, borderColor: 'rgba(167, 168, 169, 1', backgroundColor: 'rgba(167, 168, 169, 1', pointBackgroundColor: '#a7a8a9', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0},{ label: 'Twitter', data: cvBlock19MoodGraphDatasetData, borderColor: 'rgba(238, 198, 204, 1', backgroundColor: 'rgba(238, 198, 204, 1', pointBackgroundColor: '#eec6cc', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock16MoodGraphDatasetDataString != '' && cvBlock18MoodGraphDatasetDataString != '' && cvBlock19MoodGraphDatasetDataString != '' && cvMoodAggrGraphDatasetDataString != '')
    {
        ...
        datasetDataStringLength = cvBlock16MoodGraphDatasetDataString.length;
        datalablesData = cvBlock16MoodGraphDatalablesData;
        datasetsContent = [{ label: 'Aggregate', data: cvMoodAggrGraphDatasetData, borderColor: 'rgba(118, 119, 122, 1)', backgroundColor: 'rgba(118, 119, 122, 0.7)', pointBackgroundColor: '#76777a', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0},{ label: 'YouTube', data: cvBlock16MoodGraphDatasetData, borderColor: 'rgba(255, 205, 3, 1)', backgroundColor: 'rgba(255, 205, 3, 1)', pointBackgroundColor: '#ffcd03', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0},{ label: 'TikTok', data: cvBlock18MoodGraphDatasetData, borderColor: 'rgba(167, 168, 169, 1', backgroundColor: 'rgba(167, 168, 169, 1', pointBackgroundColor: '#a7a8a9', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0},{ label: 'Twitter', data: cvBlock19MoodGraphDatasetData, borderColor: 'rgba(238, 198, 204, 1', backgroundColor: 'rgba(238, 198, 204, 1', pointBackgroundColor: '#eec6cc', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock17MoodGraphDatasetDataString != '' && cvBlock18MoodGraphDatasetDataString != '' && cvBlock19MoodGraphDatasetDataString != '' && cvMoodAggrGraphDatasetDataString != '')
    {
        ...
        datasetsContent = [{ label: 'Aggregate', data: cvMoodAggrGraphDatasetData, borderColor: 'rgba(118, 119, 122, 1)', backgroundColor: 'rgba(118, 119, 122, 0.7)', pointBackgroundColor: '#76777a', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0},{ label: 'Instagram', data: cvBlock17MoodGraphDatasetData, borderColor: 'rgba(221, 135, 151, 1)', backgroundColor: 'rgba(221, 135, 151, 1)', pointBackgroundColor: '#dd8797', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0},{ label: 'TikTok', data: cvBlock18MoodGraphDatasetData, borderColor: 'rgba(167, 168, 169, 1', backgroundColor: 'rgba(167, 168, 169, 1', pointBackgroundColor: '#a7a8a9', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0},{ label: 'Twitter', data: cvBlock19MoodGraphDatasetData, borderColor: 'rgba(238, 198, 204, 1', backgroundColor: 'rgba(238, 198, 204, 1', pointBackgroundColor: '#eec6cc', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock18MoodGraphDatasetDataString != '' && cvBlock19MoodGraphDatasetDataString != '' && cvMoodAggrGraphDatasetDataString != '')
    {
        ...
        datasetsContent = [{ label: 'Aggregate', data: cvMoodAggrGraphDatasetData, borderColor: 'rgba(118, 119, 122, 1)', backgroundColor: 'rgba(118, 119, 122, 0.7)', pointBackgroundColor: '#76777a', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0},{ label: 'TikTok', data: cvBlock18MoodGraphDatasetData, borderColor: 'rgba(167, 168, 169, 1', backgroundColor: 'rgba(167, 168, 169, 1', pointBackgroundColor: '#a7a8a9', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0},{ label: 'Twitter', data: cvBlock19MoodGraphDatasetData, borderColor: 'rgba(238, 198, 204, 1', backgroundColor: 'rgba(238, 198, 204, 1', pointBackgroundColor: '#eec6cc', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock16MoodGraphDatasetDataString != '')
    {
        ...
        datasetDataStringLength = cvBlock16MoodGraphDatasetDataString.length;
        datalablesData = cvBlock16MoodGraphDatalablesData;
        datasetsContent = [{ label: 'YouTube', data: cvBlock16MoodGraphDatasetData, borderColor: 'rgba(255, 205, 3, 1)', backgroundColor: 'rgba(255, 205, 3, 1)', pointBackgroundColor: '#ffcd03', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock17MoodGraphDatasetDataString != '')
    {
        ...
        datasetDataStringLength = cvBlock17MoodGraphDatasetDataString.length;
        datalablesData = cvBlock17MoodGraphDatalablesData;
        datasetsContent = [{ label: 'Instagram', data: cvBlock17MoodGraphDatasetData, borderColor: 'rgba(221, 135, 151, 1)', backgroundColor: 'rgba(221, 135, 151, 1)', pointBackgroundColor: '#dd8797', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock18MoodGraphDatasetDataString != '')
    {
        ...
        datasetDataStringLength = cvBlock18MoodGraphDatasetDataString.length;
        datalablesData = cvBlock18MoodGraphDatalablesData;
        datasetsContent = [{ label: 'TikTok', data: cvBlock18MoodGraphDatasetData, borderColor: 'rgba(167, 168, 169, 1', backgroundColor: 'rgba(167, 168, 169, 1', pointBackgroundColor: '#a7a8a9', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock19MoodGraphDatasetDataString != '')
    {
        ...
        datasetsContent = [{ label: 'Twitter', data: cvBlock19MoodGraphDatasetData, borderColor: 'rgba(238, 198, 204, 1)', backgroundColor: 'rgba(238, 198, 204, 1)', pointBackgroundColor: '#eec6cc', pointBorderColor: '#232323', pointBorderWidth: 0, pointRadius: 0}];
