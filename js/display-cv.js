/* <script> */
    ...
    console.log("b13DataCount",b13DataCount);
...
//Start RADAR Graph Script 1
    ...
    if(cvBlock16MoodGraphDatasetDataString != '' && cvBlock17MoodGraphDatasetDataString != '' && cvBlock18MoodGraphDatasetDataString != '' && cvBlock19MoodGraphDatasetDataString != '' && cvMoodAggrGraphDatasetDataString != '')
    {
        ...
        datasetsContent = [{ label: 'Aggregate', data: cvMoodAggrGraphDatasetData, borderColor: mgAggrBColorVal, backgroundColor: mgAggrBgColorVal, pointBackgroundColor: mgAggrPbgColorVal, pointBorderColor: mgAggrPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'YouTube', data: cvBlock16MoodGraphDatasetData, borderColor: mgYtBColorVal, backgroundColor: mgYtBgColorVal, pointBackgroundColor: mgYtPbgColorVal, pointBorderColor: mgYtPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'Instagram', data: cvBlock17MoodGraphDatasetData, borderColor: mgIgBColorVal, backgroundColor: mgIgBgColorVal, pointBackgroundColor: mgIgPbgColorVal, pointBorderColor: mgIgPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'TikTok', data: cvBlock18MoodGraphDatasetData, borderColor: mgTtBColorVal, backgroundColor: mgTtBgColorVal, pointBackgroundColor: mgTtPbgColorVal, pointBorderColor: mgTtPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'Twitter', data: cvBlock19MoodGraphDatasetData, borderColor: mgTwtBColorVal, backgroundColor: mgTwtBgColorVal, pointBackgroundColor: mgTwtPbgColorVal, pointBorderColor: mgTwtPbColorVal, pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock16MoodGraphDatasetDataString != '' && cvBlock18MoodGraphDatasetDataString != '' && cvBlock19MoodGraphDatasetDataString != '' && cvMoodAggrGraphDatasetDataString != '')
    {
        ...
        datasetDataStringLength = cvBlock16MoodGraphDatasetDataString.length;
        datalablesData = cvBlock16MoodGraphDatalablesData;
        datasetsContent = [{ label: 'Aggregate', data: cvMoodAggrGraphDatasetData, borderColor: mgAggrBColorVal, backgroundColor: mgAggrBgColorVal, pointBackgroundColor: mgAggrPbgColorVal, pointBorderColor: mgAggrPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'YouTube', data: cvBlock16MoodGraphDatasetData, borderColor: mgYtBColorVal, backgroundColor: mgYtBgColorVal, pointBackgroundColor: mgYtPbgColorVal, pointBorderColor: mgYtPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'TikTok', data: cvBlock18MoodGraphDatasetData, borderColor: mgTtBColorVal, backgroundColor: mgTtBgColorVal, pointBackgroundColor: mgTtPbgColorVal, pointBorderColor: mgTtPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'Twitter', data: cvBlock19MoodGraphDatasetData, borderColor: mgTwtBColorVal, backgroundColor: mgTwtBgColorVal, pointBackgroundColor: mgTwtPbgColorVal, pointBorderColor: mgTwtPbColorVal, pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock17MoodGraphDatasetDataString != '' && cvBlock18MoodGraphDatasetDataString != '' && cvBlock19MoodGraphDatasetDataString != '' && cvMoodAggrGraphDatasetDataString != '')
    {
        ...
        datasetsContent = [{ label: 'Aggregate', data: cvMoodAggrGraphDatasetData, borderColor: mgAggrBColorVal, backgroundColor: mgAggrBgColorVal, pointBackgroundColor: mgAggrPbgColorVal, pointBorderColor: mgAggrPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'Instagram', data: cvBlock17MoodGraphDatasetData, borderColor: mgIgBColorVal, backgroundColor: mgIgBgColorVal, pointBackgroundColor: mgIgPbgColorVal, pointBorderColor: mgIgPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'TikTok', data: cvBlock18MoodGraphDatasetData, borderColor: mgTtBColorVal, backgroundColor: mgTtBgColorVal, pointBackgroundColor: mgTtPbgColorVal, pointBorderColor: mgTtPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'Twitter', data: cvBlock19MoodGraphDatasetData, borderColor: mgTwtBColorVal, backgroundColor: mgTwtBgColorVal, pointBackgroundColor: mgTwtPbgColorVal, pointBorderColor: mgTwtPbColorVal, pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock16MoodGraphDatasetDataString != '' && cvBlock19MoodGraphDatasetDataString != '' && cvMoodAggrGraphDatasetDataString != '')
    {
        ...
        datasetDataStringLength = cvBlock16MoodGraphDatasetDataString.length;
        datalablesData = cvBlock16MoodGraphDatalablesData;
        datasetsContent = [{ label: 'Aggregate', data: cvMoodAggrGraphDatasetData, borderColor: mgAggrBColorVal, backgroundColor: mgAggrBgColorVal, pointBackgroundColor: mgAggrPbgColorVal, pointBorderColor: mgAggrPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'YouTube', data: cvBlock16MoodGraphDatasetData, borderColor: mgYtBColorVal, backgroundColor: mgYtBgColorVal, pointBackgroundColor: mgYtPbgColorVal, pointBorderColor: mgYtPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'Twitter', data: cvBlock19MoodGraphDatasetData, borderColor: mgTwtBColorVal, backgroundColor: mgTwtBgColorVal, pointBackgroundColor: mgTwtPbgColorVal, pointBorderColor: mgTwtPbColorVal, pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock18MoodGraphDatasetDataString != '' && cvBlock19MoodGraphDatasetDataString != '' && cvMoodAggrGraphDatasetDataString != '')
    {
        ...
        datasetsContent = [{ label: 'Aggregate', data: cvMoodAggrGraphDatasetData, borderColor: mgAggrBColorVal, backgroundColor: mgAggrBgColorVal, pointBackgroundColor: mgAggrPbgColorVal, pointBorderColor: mgAggrPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'TikTok', data: cvBlock18MoodGraphDatasetData, borderColor: mgTtBColorVal, backgroundColor: mgTtBgColorVal, pointBackgroundColor: mgTtPbgColorVal, pointBorderColor: mgTtPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'Twitter', data: cvBlock19MoodGraphDatasetData, borderColor: mgTwtBColorVal, backgroundColor: mgTwtBgColorVal, pointBackgroundColor: mgTwtPbgColorVal, pointBorderColor: mgTwtPbColorVal, pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock16MoodGraphDatasetDataString != '' && cvBlock17MoodGraphDatasetDataString != '' && cvBlock18MoodGraphDatasetDataString != '' && cvBlock19MoodGraphDatasetDataString != '')
    {
        ...
        datasetDataStringLength = cvBlock16MoodGraphDatasetDataString.length;
        datalablesData = cvBlock16MoodGraphDatalablesData;
        datasetsContent = [{ label: 'YouTube', data: cvBlock16MoodGraphDatasetData, borderColor: mgYtBColorVal, backgroundColor: mgYtBgColorVal, pointBackgroundColor: mgYtPbgColorVal, pointBorderColor: mgYtPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'Instagram', data: cvBlock17MoodGraphDatasetData, borderColor: mgIgBColorVal, backgroundColor: mgIgBgColorVal, pointBackgroundColor: mgIgPbgColorVal, pointBorderColor: mgIgPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'TikTok', data: cvBlock18MoodGraphDatasetData, borderColor: mgTtBColorVal, backgroundColor: mgTtBgColorVal, pointBackgroundColor: mgTtPbgColorVal, pointBorderColor: mgTtPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'Twitter', data: cvBlock19MoodGraphDatasetData, borderColor: mgTwtBColorVal, backgroundColor: mgTwtBgColorVal, pointBackgroundColor: mgTwtPbgColorVal, pointBorderColor: mgTwtPbColorVal, pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock16MoodGraphDatasetDataString != '' && cvBlock18MoodGraphDatasetDataString != '' && cvBlock19MoodGraphDatasetDataString != '')
    {
        ...
        datasetDataStringLength = cvBlock16MoodGraphDatasetDataString.length;
        datalablesData = cvBlock16MoodGraphDatalablesData;
        datasetsContent = [{ label: 'YouTube', data: cvBlock16MoodGraphDatasetData, borderColor: mgYtBColorVal, backgroundColor: mgYtBgColorVal, pointBackgroundColor: mgYtPbgColorVal, pointBorderColor: mgYtPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'TikTok', data: cvBlock18MoodGraphDatasetData, borderColor: mgTtBColorVal, backgroundColor: mgTtBgColorVal, pointBackgroundColor: mgTtPbgColorVal, pointBorderColor: mgTtPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'Twitter', data: cvBlock19MoodGraphDatasetData, borderColor: mgTwtBColorVal, backgroundColor: mgTwtBgColorVal, pointBackgroundColor: mgTwtPbgColorVal, pointBorderColor: mgTwtPbColorVal, pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock16MoodGraphDatasetDataString != '' && cvBlock19MoodGraphDatasetDataString != '')
    {
        ...
        datasetDataStringLength = cvBlock16MoodGraphDatasetDataString.length;
        datalablesData = cvBlock16MoodGraphDatalablesData;
        datasetsContent = [{ label: 'YouTube', data: cvBlock16MoodGraphDatasetData, borderColor: mgYtBColorVal, backgroundColor: mgYtBgColorVal, pointBackgroundColor: mgYtPbgColorVal, pointBorderColor: mgYtPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'Twitter', data: cvBlock19MoodGraphDatasetData, borderColor: mgTwtBColorVal, backgroundColor: mgTwtBgColorVal, pointBackgroundColor: mgTwtPbgColorVal, pointBorderColor: mgTwtPbColorVal, pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock18MoodGraphDatasetDataString != '' && cvBlock19MoodGraphDatasetDataString != '')
    {
        ...
        datasetDataStringLength = cvBlock18MoodGraphDatasetDataString.length;
        datalablesData = cvBlock18MoodGraphDatalablesData;
        datasetsContent = [{ label: 'TikTok', data: cvBlock18MoodGraphDatasetData, borderColor: mgTtBColorVal, backgroundColor: mgTtBgColorVal, pointBackgroundColor: mgTtPbgColorVal, pointBorderColor: mgTtPbColorVal, pointBorderWidth: 0, pointRadius: 0},{ label: 'Twitter', data: cvBlock19MoodGraphDatasetData, borderColor: mgTwtBColorVal, backgroundColor: mgTwtBgColorVal, pointBackgroundColor: mgTwtPbgColorVal, pointBorderColor: mgTwtPbColorVal, pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock16MoodGraphDatasetDataString != '')
    {
        ...
        datasetDataStringLength = cvBlock16MoodGraphDatasetDataString.length;
        datalablesData = cvBlock16MoodGraphDatalablesData;
        datasetsContent = [{ label: 'YouTube', data: cvBlock16MoodGraphDatasetData, borderColor: mgYtBColorVal, backgroundColor: mgYtBgColorVal, pointBackgroundColor: mgYtPbgColorVal, pointBorderColor: mgYtPbColorVal, pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock17MoodGraphDatasetDataString != '')
    {
        ...
        datasetDataStringLength = cvBlock17MoodGraphDatasetDataString.length;
        datalablesData = cvBlock17MoodGraphDatalablesData;
        datasetsContent = [{ label: 'Instagram', data: cvBlock17MoodGraphDatasetData, borderColor: mgIgBColorVal, backgroundColor: mgIgBgColorVal, pointBackgroundColor: mgIgPbgColorVal, pointBorderColor: mgIgPbColorVal, pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock18MoodGraphDatasetDataString != '')
    {
        ...
        datasetDataStringLength = cvBlock18MoodGraphDatasetDataString.length;
        datalablesData = cvBlock18MoodGraphDatalablesData;
        datasetsContent = [{ label: 'TikTok', data: cvBlock18MoodGraphDatasetData, borderColor: mgTtBColorVal, backgroundColor: mgTtBgColorVal, pointBackgroundColor: mgTtPbgColorVal, pointBorderColor: mgTtPbColorVal, pointBorderWidth: 0, pointRadius: 0}];
    ...
    else if(cvBlock19MoodGraphDatasetDataString != '')
    {
        ...
        datasetsContent = [{ label: 'Twitter', data: cvBlock19MoodGraphDatasetData, borderColor: mgTwtBColorVal, backgroundColor: mgTwtBgColorVal, pointBackgroundColor: mgTwtPbgColorVal, pointBorderColor: mgTwtPbColorVal, pointBorderWidth: 0, pointRadius: 0}];
    ...
    if(showMoodRadar == true)
    {
        ...
        // console.log("socialMediaDataExistArray mood",socialMediaDataExistArray);
        // console.log("toggellblArr mood",toggellblArr);
        // for(var i=0; i<toggellblArr.length;i++)
        // {
        //     if(socialMediaDataExistArray.includes(toggellblArr[i])){
        ...
        //         toggelBtns += '<input type="checkbox" id="toggle'+toggellblArr[i]+'" >';
        //         toggelBtns += '<label for="toggle'+toggellblArr[i]+'" class="toggle'+toggellblArr[i]+'" onClick="toggleData('+i+')" style="background: transparent"><span class="toggle'+toggellblArr[i]+'_handler"></span></label>';
        //         toggelBtns += '<span class="cust-toggleBtnName">'+toggellblArr[i]+'</span>';
        //         toggelBtns += '</div>';
        //     }
        // }
        ...
        for(var i=0; i<socialMediaDataExistArray.length;i++){
            ...
            if(toggellblArr.includes(socialMediaDataExistArray[i])){
                ...
                //console.log("toggellblArrIndex ==",toggellblArrIndex);
                toggelBtns += '<div class="toggleWrapper" >';
                ...
                moodChartDefaultActiveToggelBtnsArr.push(Index);
        ...
        // console.log("radarChart1 datalablesData",datalablesData);
        //console.log("radarChart1 datasetsContent",datasetsContent);
...
//Start RADAR Graph Script 2
    ...
    else if(cvBlock17GenreGraphDatasetDataString != '' && cvBlock18GenreGraphDatasetDataString != '' && cvBlock19GenreGraphDatasetDataString != '' && cvGenreAggrGraphDatasetDataString != '')
    {
        ...
        for(var i=0; i<cvGenreAggrGraphDatasetData.length; i++)
        {
            datasetsContentAggr.push({"label": cvBlock17GenreGraphDatalablesData[i], "value": parseFloat(cvGenreAggrGraphDatasetData[i])});
            datasetsContent.push({"label": cvBlock17GenreGraphDatalablesData[i], "value": parseFloat(cvGenreAggrGraphDatasetData[i])});
        }
        for(var i=0; i<cvBlock17GenreGraphDatasetData.length; i++)
        {
    ...
    else if(cvBlock18GenreGraphDatasetDataString != '' && cvBlock19GenreGraphDatasetDataString != '' && cvGenreAggrGraphDatasetDataString != '')
    {
        ...
        for(var i=0; i<cvGenreAggrGraphDatasetData.length; i++)
        {
            datasetsContentAggr.push({"label": cvBlock18GenreGraphDatalablesData[i], "value": parseFloat(cvGenreAggrGraphDatasetData[i])});
            datasetsContent.push({"label": cvBlock18GenreGraphDatalablesData[i], "value": parseFloat(cvGenreAggrGraphDatasetData[i])});
        }
        for(var i=0; i<cvBlock18GenreGraphDatasetData.length; i++)
        {
    ...
    if(showMoodRadar == true)
    {
        ...
        // var socialMediaDataExistArray = social_media_data_exist_array.split(",");
        // console.log("socialMediaDataExistArray genre ",socialMediaDataExistArray," toggellbl1Arr",toggellbl1Arr);
        ...
        else
        {
            // for(var i=0; i<toggellbl1Arr.length;i++)
            // {
            //     if(socialMediaDataExistArray.includes(toggellbl1Arr[i])){
            //         toggel1Btns += '<div class="toggleWrapper">';
            //         toggel1Btns += '<input type="checkbox" id="r2toggle'+toggellbl1Arr[i]+'" >';
            ...
            //         toggel1Btns += '<div class="toggleWrapper" style="pointer-events:none">';
            //         toggel1Btns += '<input type="checkbox" id="r2toggle'+toggellbl1Arr[i]+'" >';
            //         toggel1Btns += '<label for="r2toggle'+toggellbl1Arr[i]+'" class="r2toggle'+toggellbl1Arr[i]+'" onClick="toggleDataBrandCV(\''+toggellbl1Arr[i]+'\', \'withoutPopup\')" style="background: transparent;"><span class="r2toggle'+toggellbl1Arr[i]+'_handler"></span></label>';
            //         toggel1Btns += '<span class="cust-toggleBtnName">'+toggellbl1Arr[i]+'</span>';
            //         toggel1Btns += '</div>';
            //     }
...
setTimeout(function()
{
    if($(window).width() >992)
    {
        ...
        var lpSection1012  = $(".lp_section_101112").height();
        ...
        {
            $(".analysied_video_social_media_stats_section").css("height",lpSectionVideoAnalysedInner + 25 );
        }
        else
        {
            $(".analysied_video_social_media_stats_section").css("height",lpSection101112Inner + 25);
        }
...
function getRadarChartGraphData(call_from,data_id){
    var datasetdata = '';
    var datalablesData = '';
    if(sonicLogoMainMoodGraphDataSetData.hasOwnProperty(data_id)){
        ...
        datasetdata = sonicLogoMainMoodGraphDataSetData[data_id].split(',');
        datalablesData = sonicLogoMainMoodGraphDatalabelsData[data_id].split(',');
    }
...
console.log("typeof cv==",typeof sonicLogoMainMoodGraphDatalabelsData,Object.keys(sonicLogoMainMoodGraphDatalabelsData).length);
if(cv_block_6_data_object.length > 0 && Object.keys(sonicLogoMainMoodGraphDatalabelsData).length > 0){
        ...
        $.ajax({
            ...
            complete: function(){
                ...
                if(sce8DataSetsContent !='' && sce8DataSetsContent !=undefined)
                {
                    ...
                    // console.log("countSonicLogoAsPerTheCvIndustryDataString",countSonicLogoAsPerTheCvIndustryDataString);
                    if(countSonicLogoAsPerTheCvIndustryDataString != ''){
                            getDoughnutChartGraphData("Logo_Count",countSonicLogoAsPerTheCvIndustryData);
                    }
...
function getDoughnutChartGraphData(call_from,main_dataSet){
    ...
    if(call_from == "Industry_Logo"){
        console.log("Pie chart Call From Industry_Logo");
        var datasetsData = main_dataSet;
...
///==============most populer video graph show =============
function videosRadarChartGraphData(vid,index,callFrom){
    //console.log("function videosRadarChartGraphData para == ",vid,index,callFrom);

    var datasetdata = '';
    var datalablesData = '';
    if(callFrom == "mostPopuler"){
        if(mostPopulerVideosDataLabelSetData.hasOwnProperty(vid)){
            document.getElementById(`VideoMPGraphRadarChart_Holder${index}`).innerHTML = "";
            document.getElementById(`VideoMPGraphRadarChart_Holder${index}`).innerHTML =`<canvas id="VideoMPGraphRadarChart${index}"></canvas>`;
            datasetdata = mostPopulerVideosDataSetData[vid].split(',');
            datalablesData = mostPopulerVideosDataLabelSetData[vid].split(',');
        }
    }else if(callFrom == "mood"){
        if(moodVideoGraphDataArrLabelSetData.hasOwnProperty(vid)){
            document.getElementById(`VideoMoodGraphRadarChart_Holder${index}`).innerHTML = "";
            document.getElementById(`VideoMoodGraphRadarChart_Holder${index}`).innerHTML =`<canvas id="VideoMoodGraphRadarChart${index}"></canvas>`;
            datasetdata = moodVideoGraphDataArrSetData[vid].split(',');
            datalablesData = moodVideoGraphDataArrLabelSetData[vid].split(',');
        }
    }else{
        if(genreVideoGraphDataArrLabelSetData.hasOwnProperty(vid)){
            document.getElementById(`VideoGenreGraphRadarChart_Holder${index}`).innerHTML = "";
            document.getElementById(`VideoGenreGraphRadarChart_Holder${index}`).innerHTML =`<canvas id="VideoGenreGraphRadarChart${index}"></canvas>`;
            datasetdata = genreVideoGraphDataArrSetData[vid].split(',');
            datalablesData = genreVideoGraphDataArrLabelSetData[vid].split(',');
        }
    }


    // console.log("videos graph_data",vid,datasetdata,datalablesData);

    datasetsContent = [{data:datasetdata, borderColor: mgYtBColorVal, backgroundColor: mgYtBgColorVal, pointBackgroundColor: mgYtPbgColorVal, pointBorderColor: mgYtPbColorVal, pointBorderWidth: 0, pointRadius: 0}]

    if(callFrom == "mostPopuler"){

        var ctx = document.getElementById(`VideoMPGraphRadarChart${index}`).getContext('2d');

    }else if(callFrom == "mood"){

        var ctx = document.getElementById(`VideoMoodGraphRadarChart${index}`).getContext('2d');
    }else{

        var ctx = document.getElementById(`VideoGenreGraphRadarChart${index}`).getContext('2d');
    }
    // downSlradarGraphDataSetcontent = datasetsContent;
    // downSlradarGraphDataLabelcontent = datalablesData;
    ...
    const VideoGraphRadarChart = new Chart(ctx, {
            type: 'radar',
            plugins: [ChartDataLabels],
            data:{
                labels:datalablesData,
            ...
            options: {
                ...
                plugins: {
                    ...
                    tooltip: {
                        callbacks: {
                            label: function(context) {
                                let label = VideoGraphRadarChart.data.datasets.labels;
                                return label;
                            }
                        }
                    }
...
setTimeout(()=>{
    ...
    }else if(Object.keys(mostPopulerVideosDataLabelSetData).length == 0 && Object.keys(moodVideoGraphDataArrLabelSetData).length > 0){
